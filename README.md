...
### 方式一：Cloudflare Pages 部署（免费）
完全基于 **Cloudflare Pages** + **KV** 构建，无需服务器，永久免费。

> **📥 [点击下载完整图文教程 (.docx)](图文教程.docx)**

### 方式二：Docker 部署（推荐自建）
适合有自己服务器或 NAS 的用户，数据完全自主掌控。

> **📖 [查看 Docker 部署完整文档](doc/docker/)**

**快速开始：**

```bash
# 创建 docker-compose.yml
wget https://raw.githubusercontent.com/你的用户名/CloudNav-abcd/main/docker-compose.yml

# 修改密码
nano docker-compose.yml  # 将 your_password_here 改为你的密码
...
- [兼容性保证](doc/docker/COMPATIBILITY_GUARANTEE.md) - 不影响 CF Pages
